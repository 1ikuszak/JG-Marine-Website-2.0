        ...
        <div className="container relative mx-auto max-w-screen-xl px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <motion.h1
              ...
              className="font-serif text-display-sm md:text-display font-bold text-white mb-6"
            >
            ...
            <motion.div
              ...
              className="space-y-4 text-body md:text-body-lg text-white/70 mb-12 max-w-3xl mx-auto"
            >
              {/* MEDIUM sentence */}
              <p>
            ...
            >
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-lg">
                ...
                <p className="font-serif text-h3-sm md:text-h3 font-bold text-white mb-1">20+</p>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-lg">
                ...
                <p className="font-serif text-h3-sm md:text-h3 font-bold text-white mb-1">DNV</p>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-lg">
                ...
                <p className="font-serif text-h3-sm md:text-h3 font-bold text-white mb-1">64</p>
