    ...
    >
      <div className="relative h-full bg-card border-2 border-border hover:border-primary hover:shadow-2xl hover:shadow-primary/20 transition-all duration-500 overflow-hidden">
        ...
        <div className="absolute top-4 right-4 z-10">
          <Badge
            variant="secondary"
            className="bg-primary/90 text-primary-foreground backdrop-blur-sm border-none"
          >
            {category}
          </Badge>
        </div>
        ...
        {/* Certificate Image */}
        <div className="relative h-80 bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5 overflow-hidden">
          <Image
            src={imageUrl}
          ...
          {/* Overlay on Hover */}
          <div className="absolute inset-0 bg-gradient-to-t from-foreground/90 via-foreground/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end justify-center pb-8">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex items-start gap-2 text-muted-foreground">
            ...
            <p className="text-sm font-medium">{issuingAuthority}</p>
          </div>
